...
void initGdt(void) {
	...
	setGdtEntry(1,0,0xfffff,0x9a,0xc); // Kernel mode segment - Code segment
	setGdtEntry(2,0,0xfffff,0x92,0xc); // Kernel mode segment - Data segment
	setGdtEntry(3,0,0xfffff,0xfa,0xc); // User mode segment - Code segment
	setGdtEntry(4,0,0xfffff,0xf2,0xc); // User mode segment - Data segment
